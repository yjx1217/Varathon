...
#  example: Rscript --vanilla --slave CNV_segmentation_by_DNAcopy.R  --input input.bam_ratio.txt --prefix output_prefix --ploidy 1 --genome_fai ref.genom.fai
##############################################################
...
if (nrow(ratio_data) > 0) {		       
   ...
   segment_data$loc.end <- segment_data$loc.end - 1
