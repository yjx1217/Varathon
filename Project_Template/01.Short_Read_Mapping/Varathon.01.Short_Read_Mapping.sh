...
min_mapping_quality=20 # The minimal mapping quality to use for filtering short-read mapping alignment. Default = 20.
local_realign="yes" # Whether to perform local realignment around INDELs (powerved by GATK3). Default = "yes".
